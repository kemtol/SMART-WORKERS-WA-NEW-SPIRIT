...
Jika setelah scan muncul `Stream Errored (restart required)`, biarkan script berjalan. `connect.sh` akan restart otomatis. Jika login belum selesai, script akan membersihkan auth sementara dan membuat QR baru.
